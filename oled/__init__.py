...
def _create_device(options: argparse.Namespace) -> luma_device:
    ...
    # https://github.com/rm-hull/luma.oled/issues/309#issuecomment-935248846
    ssd1305_workaround = options.display == "ssd1305"
...
def main() -> None:
    ...
    # Add ssd1305 to the display choices from luma_cmdline
